...
--SELECT COUNT (SalesQuantity) AS 'Qtd Vendida' FROM FactSales
 
--SELECT COUNT (ReturnQuantity) AS 'Qtd Devolvida' FROM FactSales
...
--SELECT StoreName AS 'Nome da Loja', EmployeeCount AS 'Qtd Funcionários' FROM DimStore ORDER BY EmployeeCount DESC -- 1º Opção Exibirá na 1 linha de registro
...
--d.Qual é o nome dessa loja?--SELECT StoreName AS 'Nome da Loja', EmployeeCount AS 'Menor Qtd Funcionários' FROM DimStore WHERE EmployeeCount IS NOT NULL ORDER BY EmployeeCount --1º Opção está na 1 linha de registro--SELECT StoreName FROM DimStore WHERE EmployeeCount = '7' --2º Opção exibirá uma linha de registro com a resposta---------------------------------------------------------------------------------------------------------------------
